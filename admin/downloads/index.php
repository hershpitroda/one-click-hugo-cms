	...
	<div id="content" class="admin">
        ...
        <div id="main">
			...
			?>
             <div class="opt-box">
            	<ul>
                	<li><strong>Total downloads: </strong><?php echo $record_count;?></li>
                    <li class="filter" style="margin-top:20px;">
                    	<h3>OPTIONS</h3>
                        <ul id="options">
                        	<li><a href="#" class="enable_sel_dl btn" onClick="return false;">Enable</a></li>
                            <li><a href="#" class="disable_sel_dl btn" onClick="return false;">Disable</a></li>
            ...
            <ul class="plist downloads">
                ...
                <li class="col4">
                  ...
                  <li class="col1"><input type="checkbox" name="chk_box_<?php echo $rows['download_id']; ?>" id="chk_box_<?php echo $rows['download_id']; ?>" /></li>
                <li class="col5"><?php echo $download_active; ?></li>
            </ul>
			<?php
					}
				}
