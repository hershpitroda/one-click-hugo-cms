<%@include file="dbconnection.jsp"%><%@page import="java.util.Random"%><jsp:useBean id="list1" scope="page" class="bean.Retrieve"/><%@ page language="java" import="com.jspsmart.upload.*"%>
...
<%
	...
	fpath = fpath.substring(0,x)+"/upload/bigimage/";
	...
	if(list1.getNextRow())
	{
		if(list1.getStringColumn("bigimage")!=null && !list1.getStringColumn("bigimage").equals("null"))
		{
			String delfpath = application.getRealPath("/");
			delfpath = delfpath+"admin/upload/bigimage/"+list1.getStringColumn("bigimage");
	...
	String sql = "update product set bigimage='"+fname+"' where prodId="+ val[0];
	list.add(sql,myCon);
