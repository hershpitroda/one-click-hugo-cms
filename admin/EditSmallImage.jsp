<html>
<head><title>Edit Small Image</title>
...
<form	 ENCTYPE="multipart/form-data" name="form1" method="post" action="EditSmallImage1.jsp" onsubmit="return f1()">
<table border="0" cellpadding="1" cellspacing="2"align="center" width="96%" class="table">
	<tr class="tablehead">
		<td colspan="5">Edit File Upload</td>
   </tr>
   <tr class="altercell2">
	<% if(request.getParameter("name1").equals("null") || request.getParameter("name1").equals("") || request.getParameter("name1").equals(" "))
		  {%>
		 ...
		 <% }
		  ...
		  {%>
				...
				Name :</font></td>
				<td colspan=3 width="79%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=request.getParameter("name1")%></font></td>
		  <%}%>
   ...
   <tr class="altercell2">
        ...
        :</font></td>
		<td width="79%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
