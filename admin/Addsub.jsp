...
<script language="javascript">
	function CheckUser(){
		...
		var SubCategory=document.form1.MainCat.value;
				var pid=document.form1.catid.value;
		var url = "CheckSubCategory.jsp?pid="+pid+"&SubCategory="+SubCategory+"&flag=add";
		//alert(url);
		var a ;
			...
			else if(restext==1)
			{
				...
				alert("This Sub Category Name already exist.");
				
				document.form1.MainCat.focus();
			
				return false;
			}
              var ascii = (document.form1.MainCat.value).charCodeAt(0);
		if(ascii ==32)
		{
   ...
   if(document.form1.blfile.value!="")
			{
				...
				if(fname.indexOf(".gif")>0 || fname.indexOf(".JPG")>0 || fname.indexOf(".bmp")>0 ||  fname.indexOf(".jpg")>0)
					{
...
<center>
	<table width="500" border="0" cellspacing="1" cellpadding="2" class="table">
		<tr>
		     <td width="500" align=right><a href="javascript: window.close()" class="text"><b>Close</a></b></td></tr>
    <tr><td colspan="7" bgcolor="white"  align="left" width="500" class="text"><font color=red>*</font> Marks Mandatory</td>
   </tr>
	
	 <form name="form1" method="POST" ENCTYPE="MULTIPART/FORM-DATA" action="Addsub1.jsp" onSubmit="return checkfields()">
	<table width="500" border="0" cellspacing="1" cellpadding="2" class="table1">
		<tr class="tablehead">
			<td colspan=5 align=left><strong><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Add Sub Category</font></strong></td>
		</tr>
		
		<tr class="altercell2">
		<input type=hidden name=catid value=<%=request.getParameter("catid")%>>
			<td align="right" width="30%"><b> Category <font color=red>*</font></b></td>
			<td align="left" width="40%">&nbsp;&nbsp;<%=request.getParameter("name")%></td>
		</tr>
		
		<tr class="altercell2">
			<td align="right" width="30%"><b>Sub Category <font color=red>*</font></b></td>
			<td align="left" width="40%"><input type="text" name="MainCat" maxlength=50 size="45"  onKeypress='if (((event.keyCode < 65 || event.keyCode > 90) && (event.keyCode < 48 || event.keyCode > 57) && (event.keyCode < 97 || event.keyCode > 122)) && event.keyCode !=13 && event.keyCode !=32) event.returnValue = false;'></td>
		</tr>
		<tr class="altercell2">
			<td align="right" width="30%"><b>Image <font color=red>*</font></b></td>
			<td align="left" width="40 %"><INPUT NAME=blfile SIZE=45 TYPE=file></td>
		</tr>
		<tr class="altercell2">
